...
const schema = {
  ...
  url: `${siteConfig.url}/bueroeinigung-neuwied`,
        ...
        <div className="container mx-auto relative z-10">
          ...
          <div className="mt-8 max-w-3xl">
            ...
            <div className="flex flex-wrap gap-4">
              <Link href="/angebot?service=B%C3%BCroreinigung&city=Neuwied&source=regional-page" className="btn-primary px-8 py-3.5">Kostenloses Angebot</Link>
      ...
      <section className="section-padding bg-slate-50">
        <div className="container mx-auto">
          ...
          <div className="text-center mt-10">
            <Link href="/angebot?service=B%C3%BCroreinigung&city=Neuwied&source=regional-page" className="btn-primary inline-flex">Jetzt Angebot anfordern</Link>
          </div>
        </div>
      </section>
