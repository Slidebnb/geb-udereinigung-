...
export const metadata: Metadata = {
  title: 'Treppenhausreinigung Mayen | Huwa – Ihr lokaler Partner',
  description: 'Treppenhausreinigung in Mayen: Zuverlässige, wöchentliche Reinigung von Treppenhäusern, Eingangsbereichen & Aufzügen. Mit Protokoll für WEGs & Hausverwaltungen.',
  alternates: { canonical: `${siteConfig.url}/treppenhausreinigung-mayen` },
};
...
const schema = {
  ...
  description: 'Treppenhausreinigung in Mayen und Umgebung',
  url: `${siteConfig.url}/treppenhausreinigung-mayen`,
...
export default function TreppenhausreinigungMayen() {
  return (
    <>
      ...
      <section className="relative py-20 md:py-28 overflow-hidden" style={{ background: 'linear-gradient(135deg, #0C2340 0%, #1B3E62 100%)' }}>
        <div className="container mx-auto relative z-10">
          <Breadcrumb items={[{ label: 'Treppenhausreinigung Mayen' }]} dark />
          <div className="mt-8 max-w-3xl">
            <div className="section-label mb-4">Mayen & Umgebung</div>
            <h1 className="text-white mb-4 leading-tight">
              Treppenhausreinigung <span className="gradient-text">Mayen</span>
            </h1>
            <p className="text-slate-300 text-lg md:text-xl leading-relaxed mb-8">
              Gepflegte Treppenhäuser in Mayen – pünktlich, gründlich und mit Protokoll. Wir übernehmen die regelmäßige Reinigung von Treppenhäusern, Eingängen und Gemeinschaftsflächen für WEGs und Hausverwaltungen.
            </p>
      ...
      <section className="section-padding bg-white">
        <div className="container mx-auto grid lg:grid-cols-2 gap-16 items-start">
          <div>
            <div className="section-label">Treppenhausreinigung in Mayen</div>
            ...
            <p className="text-slate-600 leading-relaxed mb-4">
              Saubere Treppenhäuser steigern den Wert und das Wohnklima einer Immobilie. Wir betreuen Wohnanlagen in Stadtmitte, Hausen, Kürrenberg und Alzheim mit zuverlässigem, wöchentlichem Reinigungsrhythmus und Dokumentation.
            </p>
            <p className="text-slate-600 leading-relaxed">
              Jede Reinigung in Mayen wird protokolliert und im Objekt hinterlegt – Transparenz für Eigentümer, Verwalter und Mieter. Auf Wunsch erweitern wir den Service um Kellerreinigung oder Tiefgaragenpflege.
            </p>
          ...
          <div className="space-y-4">
            <details className="card p-5 group cursor-pointer">
              <summary className="font-semibold text-slate-800 cursor-pointer list-none flex justify-between items-center gap-4 text-sm">
                <span>Wie oft wird das Treppenhaus in Mayen gereinigt?</span>
              ...
              <p className="mt-3 text-slate-600 text-sm leading-relaxed">In der Regel wöchentlich – auf Wunsch auch zweiwöchentlich. Wir passen den Rhythmus an Ihre Wohnanlage in Mayen an.</p>
            </details>
            <details className="card p-5 group cursor-pointer">
              <summary className="font-semibold text-slate-800 cursor-pointer list-none flex justify-between items-center gap-4 text-sm">
              ...
              <p className="mt-3 text-slate-600 text-sm leading-relaxed">Ja – nach jedem Einsatz in Mayen wird ein Protokoll ausgefüllt und im Objekt hinterlegt. So haben Verwalter und Eigentümer jederzeit Überblick.</p>
            </details>
            <details className="card p-5 group cursor-pointer">
              <summary className="font-semibold text-slate-800 cursor-pointer list-none flex justify-between items-center gap-4 text-sm">
            ...
            <details className="card p-5 group cursor-pointer">
              <summary className="font-semibold text-slate-800 cursor-pointer list-none flex justify-between items-center gap-4 text-sm">
                <span>Betreuen Sie WEGs in Mayen?</span>
                <svg className="w-4 h-4 text-primary/50 group-open:rotate-180 transition-transform flex-shrink-0" fill="currentColor" viewBox="0 0 20 20"><path fillRule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clipRule="evenodd"/></svg>
              </summary>
              <p className="mt-3 text-slate-600 text-sm leading-relaxed">Ja, wir sind langjähriger Partner von Hausverwaltungen und WEGs in Mayen und den Ortsteilen Hausen, Kürrenberg und Alzheim. Wir kennen die gesetzlichen Anforderungen an Gemeinschaftsflächen.</p>
            </details>
          </div>
        </div>
      </section>
