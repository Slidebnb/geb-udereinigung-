  ...
  return (
    <>
      ...
      <section className="py-12 bg-primary/5 border-y border-primary/10">
        <div className="container mx-auto grid md:grid-cols-[1fr_auto] items-center gap-6">
          <div>
            <div className="text-xs font-semibold text-primary uppercase tracking-wider mb-1">Kostenloser Download</div>
            <h3 className="text-lg font-bold text-dark">Leistungsübersicht und Checklisten für Ihre Objektplanung</h3>
            <p className="text-gray-500 text-sm mt-1">PDF mit allen Huwa-Leistungsbereichen oder praktische Checklisten kostenlos herunterladen.</p>
          </div>
