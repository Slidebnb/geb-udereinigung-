...
const faqs = [
  {
    ...
    a: 'Am besten bis September. Die verfügbaren Kapazitäten sind begrenzt, da unsere Winterdienstrouten nur eine bestimmte Anzahl von Objekten aufnehmen können. Wer früh bucht, hat Priorität bei der Routenplanung und profitiert von gesichertem Service auch in schneereichen Wintern.',
  },
  {
...
export default function WinterdienstAnmeldungPage() {
      ...
      >
        <div className="container mx-auto max-w-lg text-center py-20">
          ...
          <p className="text-slate-300 text-lg mb-10">
            Wir melden uns innerhalb von 24 Stunden mit Ihrem persönlichen Saisonpreisangebot.
          </p>
    ...
    <>
        ...
        <div className="container mx-auto relative z-10">
          <Breadcrumb
            items={[
              ...
              { label: 'Anmeldung 2025/2026' },
            ]}
            dark
          />
          <div className="mt-8 max-w-3xl">
            <div className="section-label mb-4">Jetzt für Saison 2025/2026 anmelden</div>
            ...
            <div className="inline-flex items-center gap-2 bg-amber-400/10 border border-amber-400/30 rounded-full px-5 py-2.5 text-amber-300 text-sm font-semibold">
              <span>⚡</span>
              <span>Sichern Sie sich jetzt Ihren Platz für die Wintersaison</span>
            </div>
          </div>
        </div>
      </section>
            ...
            {[
              {
                icon: '📋',
                title: 'Saisonvertrag',
                desc: 'Fester Pauschalpreis für die gesamte Wintersaison – keine Überraschungen, egal wie oft wir ausrücken müssen.',
              },
              {
                icon: '📸',
        ...
        <div className="container mx-auto max-w-2xl">
          <div className="text-center mb-10">
            ...
            <h2>
              ...
              <span className="gradient-text">2025/2026 anmelden</span>
            </h2>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="card p-8 space-y-6">
            ...
            >
              {isSubmitting ? 'Wird gesendet...' : '❄️ Jetzt für Winterdienst 2025/2026 anmelden'}
            </button>
      ...
      <CTABanner
        data={{
          ...
          headline_gradient: 'Winter 2025/2026',
          subtitle:
