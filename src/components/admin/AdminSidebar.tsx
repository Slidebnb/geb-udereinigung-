...
import { BarChart3, Building2, Calculator, ClipboardList, FileCog, FileText, FolderKanban, Inbox, LayoutDashboard, Mail, Package, Settings, Users, X } from 'lucide-react';
...
const nav = [
  ...
  { href: '/admin/akquise-pdf', label: 'Akquise-PDF', icon: Mail },
  ...
  { href: '/admin/kundenlogos', label: 'Kundenlogos', icon: Building2 },
