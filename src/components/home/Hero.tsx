...
const defaultHero: Required<HeroData> = {
  ...
  subtitle:
    'Zuverlässige Reinigung für Hausverwaltungen, Gewerbe & Wohnanlagen in Neuwied, Koblenz und Bendorf – mit festen Ansprechpartnern und transparenten Festpreisen.',
  stats: [
